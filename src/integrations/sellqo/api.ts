...
export const productsAPI = {
  ...
  getBySlug: (slug: string) => sellqoFetch<Product>(`/products/${slug}`),

  getRelated: (slug: string, limit = 4) => sellqoFetch<Product[]>(`/products/${slug}/related?limit=${limit}`),
...
export const collectionsAPI = {
  getAll: () => sellqoFetch<Collection[]>("/collections"),

  getBySlug: (slug: string) => sellqoFetch<Collection>(`/collections/${slug}`),
...
export const categoriesAPI = {
  getAll: () => sellqoFetch<Category[]>("/categories"),

  getBySlug: (slug: string) => sellqoFetch<Category>(`/categories/${slug}`),
};
...
export const cartAPI = {
  ...
  get: (cartId: string) => sellqoFetch<Cart>(`/cart/${cartId}`),
  ...
  removeDiscount: (cartId: string) => sellqoFetch<Cart>(`/cart/${cartId}/discount`, { method: "DELETE" }),

  clear: (cartId: string) => sellqoFetch<Cart>(`/cart/${cartId}`, { method: "DELETE" }),
};
...
export const giftCardsAPI = {
  getAll: () => sellqoFetch<GiftCard[]>("/gift-cards"),
...
export const pagesAPI = {
  getAll: () => sellqoFetch<Page[]>("/pages"),

  getBySlug: (slug: string) => sellqoFetch<Page>(`/pages/${slug}`),

  getLegal: () => sellqoFetch<{ success: boolean; data: Page[] }>("/legal"),
};

// === NAVIGATION ===
export const navigationAPI = {
  get: () => sellqoFetch<NavigationMenu>("/navigation"),
};
...
export const reviewsAPI = {
  ...
  getSummary: () => sellqoFetch<ReviewsSummary>("/reviews/summary"),
};
...
export const settingsAPI = {
  getAll: () => sellqoFetch<StorefrontSettings>("/settings"),

  getSocial: () => sellqoFetch<StorefrontSettings["social"]>("/settings/social"),

  getTrust: () => sellqoFetch<StorefrontSettings["trust"]>("/settings/trust"),

  getConversion: () => sellqoFetch<StorefrontSettings["conversion"]>("/settings/conversion"),

  getTracking: () => sellqoFetch<StorefrontSettings["tracking"]>("/settings/tracking"),

  getCheckout: () => sellqoFetch<StorefrontSettings["checkout"]>("/settings/checkout"),

  getLanguages: () => sellqoFetch<StorefrontSettings["languages"]>("/settings/languages"),
};
